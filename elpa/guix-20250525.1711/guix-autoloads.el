;;; guix-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Display Emacs-Guix and Guix versions in the echo area." t)
(autoload 'guix-about "guix-about" "\
Display a buffer with a fancy Guix logo if available.
Switch to `guix-about-buffer-name' buffer if it already exists." t)
...
Edit the current synopsis/description in `texinfo-mode'." t)
...
Prettify shell environment variable at current line." t)
...
(fn PACKAGE BACKEND NODE-TYPE)" t)
...
Switch to `guix-help-buffer-name' buffer if it already exists." t)
...
(fn LICENSE &optional DIRECTORY)" t)
...
(fn PROFILE FILE &optional OPERATION-BUFFER)" t)
...
(fn PACKAGE-OR-FILE &optional TYPE)" t)
...
(fn PACKAGES &optional CHECKERS)" t)
...
(fn ID-OR-NAME &optional DIRECTORY)" t)
...
(fn REGEXP &optional PARAMS PROFILE)" t)
...
Display information about Guix packages installed in a user profile." t)
(autoload 'guix-installed-system-packages "guix-ui-package" "\
Display information about Guix packages installed in a system profile." t)
...
(fn PACKAGES &optional TYPE PROFILE)" t)
...
Info node `(guix) Package Modules')." t)
...
Modify `guix-profiles' variable to add more profiles." t)
(autoload 'guix-system-profile "guix-ui-profile" "\
Display interface for `guix-system-profile'." t)
(autoload 'guix-home-profile "guix-ui-profile" "\
Display interface for `guix-home-profile'." t)
(autoload 'guix-current-profile "guix-ui-profile" "\
Display interface for `guix-current-profile'." t)
...
Display all available Guix System services." t)
(autoload 'guix-all-home-services "guix-ui-service" "\
Display all available Guix Home services." t)
...
See Info node `(guix) Invoking guix gc'." t)
...
Display information about system generations." t)
...
(fn FROM TO)" t)
(register-definition-prefixes "guix-ui-system-generation" '("guix-system-"))
