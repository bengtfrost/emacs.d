...
;; the contents of `guix-command--all-arguments', but we need to make a
;; special case for `guix-command-complex-with-shared-arguments'
;; commands.
...
(defun guix-command-post-process-environment-packages (args)
  "Adjust popup ARGS for specified packages of \"guix environment\" command."
  (guix-command-post-process-matching-args
...
(defun guix-command-post-process-environment-ad-hoc (args)
  "Adjust popup ARGS for \"--ad-hoc\" argument of \"guix environment\" command."
  (guix-command-post-process-matching-args
